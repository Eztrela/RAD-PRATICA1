...
class ContatosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create contato" do
    assert_difference("Contato.count") do
      post contatos_url, params: { contato: { loja_id: @contato.loja_id, tipo: @contato.tipo, valor: @contato.valor } }
    end
  ...
  test "should update contato" do
    patch contato_url(@contato), params: { contato: { loja_id: @contato.loja_id, tipo: @contato.tipo, valor: @contato.valor } }
