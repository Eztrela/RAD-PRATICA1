class LojasController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @loja.save
        format.html { redirect_to root_path, notice: "Loja was successfully created." }
  ...
  def update
    respond_to do |format|
      if @loja.update(loja_params)
        format.html { redirect_to root_path, notice: "Loja was successfully updated." }
  ...
  private
    ...
    def loja_params
      params.require(:loja).permit(:nome, gerente_attributes: [:id, :nome, :nascimento])
    end
end
